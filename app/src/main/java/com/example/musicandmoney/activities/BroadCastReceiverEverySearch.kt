...
class BroadCastReceiverEverySearch  : BroadcastReceiver(), MediaPlayer.OnCompletionListener{
        ...
        when (intent!!.action) {
            Application.PREVIOUS -> {
                ...
                if (EveryMusicActivity.positionMusic > 0) {
                    ...
                    previous(
                        EveryMusicActivity.musicEverySearchList[EveryMusicActivity.positionMusic],
                        context
                    )
                    ...
                    EveryMusicActivity.positionMusic = EveryMusicActivity.musicEverySearchList.size - 1
                    previous(
                        EveryMusicActivity.musicEverySearchList[EveryMusicActivity.positionMusic],
                        context
                    )
            ...
            Application.PLAY -> {
                play()
                NotificationChannelEvery(context).showNotification(EveryMusicActivity.musicEverySearchList[EveryMusicActivity.positionMusic],"Pause")
            }
            Application.PAUSE -> {
                pause()
                NotificationChannelEvery(context).showNotification(EveryMusicActivity.musicEverySearchList[EveryMusicActivity.positionMusic],"Play")
            }
            Application.NEXT -> {
                EveryMusicActivity.song!!.stop()
                if ( EveryMusicActivity.positionMusic < EveryMusicActivity.musicEverySearchList.size-1){
                    EveryMusicActivity.positionMusic += 1
                    next(EveryMusicActivity.musicEverySearchList[EveryMusicActivity.positionMusic],context)
                    NotificationChannelEvery(context).showNotification(EveryMusicActivity.musicEverySearchList[EveryMusicActivity.positionMusic],"Pause")
                }

                else if(EveryMusicActivity.positionMusic ==EveryMusicActivity.musicEverySearchList.size -1){
    ...
    override fun onCompletion(mp: MediaPlayer?) {
        ...
        val list = EveryMusicActivity.musicEverySearchList
