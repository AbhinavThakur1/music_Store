...
class NotificationChannelEverySearch (private val context: Context) {
        ...
        val notification = NotificationCompat.Builder(context , COUNTER_CHANNEL)
            ...
            .addAction(
                ...
                PendingIntent.getBroadcast(context,1,
                    Intent(context,BroadCastReceiverEverySearch::class.java).setAction(Application.PREVIOUS),
                    PendingIntent.FLAG_IMMUTABLE))
            .addAction(
                R.drawable.play_nf,playPause,
                PendingIntent.getBroadcast(context,1,
                    Intent(context,BroadCastReceiverEverySearch::class.java).setAction(playPause),
                    PendingIntent.FLAG_IMMUTABLE))
            .addAction(
                R.drawable.next_nf,"Next",
                PendingIntent.getBroadcast(context,1,
                    Intent(context,BroadCastReceiverEverySearch::class.java).setAction(Application.NEXT),
                    PendingIntent.FLAG_IMMUTABLE))
            .build()
