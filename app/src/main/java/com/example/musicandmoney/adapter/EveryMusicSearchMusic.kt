...
class EveryMusicSearchMusic (private val context: Context, private val list: ArrayList<MusicData>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return MyViewHolder(
            ...
            .inflate(
                R.layout.music_background_layout,
                parent,false))
    }
